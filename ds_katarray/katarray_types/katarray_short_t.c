...
void katarray_short_length_print(katarray_short_t *KatArray, short option) {
    if (option > 0) {
        // index
        printf(GRAY" ");
...
// set insert at
ssize_t katarray_short_set_insert_at(katarray_short_t **KatArray, ssize_t index, short value) {
